...
$i =rand(1,2);
	...
	<li><a href="#">ACTU</a>
		<ul>
			<li><a href="https://www.youtube.com/watch?v=k7DwjOfIh5E">Le Père Doriot</a></li>
			<li><a href="#">Maïté le retour</a></li>
			<li><a href="#">JDG trading Card</a></li>
		</ul>
	</li>
...
<div class="row-fluid">
	<div class="span12 slogan text-center">
		...
		<h1>Bienvenue sur DUAL BET<br> <small>Le jeu d'argent équitable</small>
